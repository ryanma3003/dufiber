...
type HargaZakatController struct {
	hargaZakatService service.HargaZakatService
}

func NewHargaZakatController(hargaZakatService service.HargaZakatService) *HargaZakatController {
	return &HargaZakatController{hargaZakatService: hargaZakatService}
}

func (h *HargaZakatController) GetAllHargaZakats(c *fiber.Ctx) error {
	...
	blogs, err := h.hargaZakatService.FindAllWithPagination(c.Context(), per_page, offset)
	if err != nil {
...
func (h *HargaZakatController) GetHargaZakatById(c *fiber.Ctx) error {
	id, err := strconv.Atoi(c.Params("id"))
	if err != nil {
		return helper.RespondError(c, fiber.StatusBadRequest, "Invalid ID")
	}

	blog, err := h.hargaZakatService.FindById(c.Context(), id)
	if err != nil {
		if e, ok := err.(helper.AppError); ok {
			return helper.RespondError(c, e.Code, e.Message)
		}
...
func (h *HargaZakatController) CreateHargaZakat(c *fiber.Ctx) error {
	userInput := new(dto.HargaZakatCreate)
	...
	if _, err := h.hargaZakatService.Create(c.Context(), userInput); err != nil {
		if e, ok := err.(helper.AppError); ok {
			return helper.RespondError(c, e.Code, e.Message)
		}
		return helper.RespondError(c, fiber.StatusInternalServerError, err.Error())
...
func (h *HargaZakatController) EditHargaZakat(c *fiber.Ctx) error {
	id, err := strconv.Atoi(c.Params("id"))
	if err != nil {
		return helper.RespondError(c, fiber.StatusBadRequest, "Invalid ID")
	}

	userInput := new(dto.HargaZakatUpdate)
	if err = c.BodyParser(userInput); err != nil {
		return helper.RespondError(c, fiber.StatusBadRequest, err.Error())
	}
	...
	if err = h.hargaZakatService.Update(c.Context(), userInput); err != nil {
		if e, ok := err.(helper.AppError); ok {
			return helper.RespondError(c, e.Code, e.Message)
		}
		return helper.RespondError(c, fiber.StatusInternalServerError, err.Error())
...
func (h *HargaZakatController) DeleteHargaZakat(c *fiber.Ctx) error {
	id, err := strconv.Atoi(c.Params("id"))
	if err != nil {
		return helper.RespondError(c, fiber.StatusBadRequest, "Invalid ID")
	}

	if err = h.hargaZakatService.Delete(c.Context(), id); err != nil {
		if e, ok := err.(helper.AppError); ok {
			return helper.RespondError(c, e.Code, e.Message)
		}
		return helper.RespondError(c, fiber.StatusInternalServerError, err.Error())
